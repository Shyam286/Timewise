...
const product = {
  name: 'Basic CALIBRE RM002-V2',
  price: '₹9999',
  href: '#',
  breadcrumbs: [
    { id: 1, name: 'Men', href: '#' },
    { id: 2, name: 'Watches0', href: '#' },
  ],
  images: [
    {
      src: 'https://sothebys-com.brightspotcdn.com/dims4/default/077f1b2/2147483647/strip/true/crop/4311x5748+0+0/resize/684x912!/format/webp/quality/90/?url=http%3A%2F%2Fsothebys-brightspot.s3.amazonaws.com%2Fdotcom%2Ffe%2F16%2F6a5aea0a4164b34c57abe4c89463%2Fhk1502-mrkt-01.jpg',
    ...
    {
      src: 'https://www.my-watchsite.com/7999-large_default/rm-002-v2-all-gray.jpg://tailwindui.com/img/ecommerce-images/product-page-02-tertiary-product-shot-02.jpg',
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className='flex space-x-5 items-center text-lg lg:text-x1 text-gray-900 mt-6'>
                ...
                <p className='opacity-50 line-through'> ₹10000 </p>
                <p className='font-semibold text-green-500'> 10% off </p>
